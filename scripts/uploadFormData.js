        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    filename = "submissions/".concat(timestamp, "-").concat(id, ".json");
                    contents = JSON.stringify(formData, null, 2);
                    return [4 /*yield*/, storage.bucket(BUCKET_NAME).file(filename).save(contents, {
                            contentType: 'application/json',
                        })];
                case 1:
                    _a.sent();
                    console.log("\u2705 Uploaded to gs://".concat(BUCKET_NAME, "/").concat(filename));
                    return [2 /*return*/];
            }
        });
    });
